...
| Test coverage | 91 | 124 tests now cover evidence-first task ordering, relevant test-file ranking, retry correction commands, Windows evidence retry boundaries, reporting, setup, discovery, and copied installs. | Real provider, interrupted-controller, scheduler, and GitHub-write integration tests. |
