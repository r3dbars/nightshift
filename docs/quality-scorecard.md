...
| Test coverage | 92 | The full discovered suite has 133 tests covering selection/feedback ordering, Python scope-aware symbol discovery, relevant test-file ranking, retry correction, reporting, setup, discovery, and copied installs. | Real provider, interrupted-controller, scheduler, and GitHub-write integration tests. |
