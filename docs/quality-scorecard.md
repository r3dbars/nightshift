...
| Test coverage | 94 | The full discovered suite has 137 tests covering strict patch-format correction and hunk recount; live Windows and Podman proof exercises the complete repair path. | Interrupted-controller, scheduler, Docker-provider, and GitHub-write integration tests. |
