...
| Test coverage | 92 | The full discovered suite has 130 tests covering selection/feedback ordering, Python nested-helper filtering, relevant test-file ranking, retry correction, reporting, setup, discovery, and copied installs. | Real provider, interrupted-controller, scheduler, and GitHub-write integration tests. |
