...
and portfolio morning briefs; the current package gate passes 472 tests on this
...
472 tests. PRs #254, #255, #256, #257, #258, #259, #261, and #263 now reject out-of-pack review citations,
require exact pinned revisions before a cloud review can be sent, persist
review outcomes atomically, and link exact valid handoff reviews to morning feedback. The
