...
| Test coverage | 94 | The full discovered suite has 148 tests covering both patch lanes plus draft publication owner/origin binding, approved-file staging, replay suppression, draft verification, close-on-violation, and cleanup. GitHub-write success is not yet integration-proven. | Interrupted-controller, scheduler, Docker-provider, and successful GitHub-write integration tests. |
