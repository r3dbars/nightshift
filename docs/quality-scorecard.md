...
| Maintainability | 50 | Evidence parsing, source validation, safety scoring, and artifact priority now live in a directly tested module; the main controller is still about 4,700 lines. | Continue splitting setup, scanning, queueing, dispatch, reporting, and lifecycle into tested modules. |
